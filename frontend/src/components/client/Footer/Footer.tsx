    ...
    <div className={cx("wrapper")}>
      <div className={cx("container")}>
        <div className={cx("footer-company")}>
          ...
          <h4>PTIT Asia Pacific</h4>
          <p>
            PTIT là một trong những hệ sinh thái nhân sự hàng đầu tại khu vực
            ...
            Được chính thức thành lập tại Singapore vào năm 2015, PTIT đã hỗ trợ
            hơn 5 triệu nhân tài và hơn 60.000 tổ chức thành công trong việc
            ...
            nhân tài. Cho đến thời điểm hiện tại, PTIT đã có mặt tại Indonesia,
            Malaysia, Singapore, Việt Nam và Đài Loan.
          </p>
          <div className={cx("footer-address")}>
            © 2024 CÔNG TY TNHH PTIT VIỆT NAM
            <br></br>
            <span>
        ...
        <div className={cx("footer-section")}>
          <div className={cx("section-item")}>
            ...
            <ul>
              ...
              <li>
                <a href="">
                  <span>Những điều thú vị tại PTIT</span>
                </a>
              </li>
              <li>
                <a href="">
              ...
              <li>
                <a href="">
                  <span>
                    Quy Chế Hoạt Động Website Cung Cấp Dịch vụ TMĐT PTIT.com/vn
                  </span>
                </a>
              </li>
              <li>
